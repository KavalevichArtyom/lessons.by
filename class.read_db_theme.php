...
class theme
	{
		...
		public function read_theme_search($section,$subsections)
			{	
				
				$this->query  = 'SELECT name, practical_work, theme, target, progress, text, href_theme FROM read_doc where sections="'.$section.'" and practical_work="'.$subsections.'" ';
				$this->result = mysql_query($this->query) or die ("Не верный запрос.");
